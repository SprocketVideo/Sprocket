...
| Auto-update (Help ▸ Check for Updates; status-bar badge with Help-menu discoverability dot + age-based colour escalation; one-time first-run toast per version; installed builds download + Install & Restart in-app with inline "what's new" release notes; portable builds link to the releases page) | Sprocket.App/UpdateService.cs; UpdateDialogs.cs; UpdateEscalation.cs; PLAN.md steps 36 + 45 | — | ❌ |
