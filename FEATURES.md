...
| get-started/projects-and-saving.md | §1 (Projects & saving); §9 (Autosave interval) | New/Open/Save/Save As, the unsaved-changes prompt, autosave + crash recovery, the autosave interval preference, or Relink Media change | c09258f | ✅ current (unsaved-changes section rewritten for Save · Don't Save · Cancel on New/Open/close/quit, plus the running-export close prompt; recovery prompt buttons Recover / Discard autosave; unsaved-changes.png re-captured) |
